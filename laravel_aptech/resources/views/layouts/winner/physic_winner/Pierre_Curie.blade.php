...
@section('winner_css')
<link href="{{ asset('/css/pierre-curie.css') }}" rel="stylesheet">
@endsection
...
{{-- Relationship --}}
    ...
    <img src="{{ asset('/icon/Pierre-CurrieMarriage.jpg') }}" alt="">
    @endsection
...
{{-- Book --}}
    {{-- Book1 --}}
        @section('book_img1')
        <img src="{{ asset('icon/Book/Perrie_Currie/A Tale of Love and Fallout.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book2 --}}
        @section('book_img2')
        <img src="{{ asset('icon/Book/Perrie_Currie/Perie Curie Book .jpg') }}" alt="">
        @endsection
    ...
    {{-- Book3 --}}
        @section('book_img3')
        <img src="{{ asset('icon/Book/Perrie_Currie/Marie Currie and Perrie Curie.jpg') }}" alt="">
        @endsection
