...
@section('winner_css')
<link href="{{ asset('/css/Erwin_Schrödinger.css') }}" rel="stylesheet">
@endsection
...
{{-- Relationship --}}
    ...
    <img src="{{ asset('/icon/schrodinger-potrait.jpg') }}" alt="">
    @endsection
...
{{-- Book --}}
    {{-- Book1 --}}
        @section('book_img1')
        <img src="{{ asset('icon/Book/Erwin_Schrödinger/What Is Life.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book2 --}}
        @section('book_img2')
        <img src="{{ asset('icon/Book/Erwin_Schrödinger/Statistical Thermodynamics.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book3 --}}
        @section('book_img3')
        <img src="{{ asset('icon/Book/Erwin_Schrödinger/My View of The World .jpg') }}" alt="">
        @endsection
