...
@section('winner_css')
<link href="{{ asset('/css/Fredrik_Bajer.css') }}" rel="stylesheet">
@endsection
...
{{-- Relationship --}}
    ...
    <img src="{{ asset('icon/Fredrik Bajer-marriage.jpg') }}" alt="">
    @endsection
...
{{-- Book --}}
    {{-- Book1 --}}
        @section('book_img1')
        <img src="{{ asset('icon/Book/Fredrik_Bajer/1.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book2 --}}
        @section('book_img2')
        <img src="{{ asset('icon/Book/Fredrik_Bajer/2.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book3 --}}
        @section('book_img3')
        <img src="{{ asset('icon/Book/Fredrik_Bajer/3.jpg') }}" alt="">
        @endsection
