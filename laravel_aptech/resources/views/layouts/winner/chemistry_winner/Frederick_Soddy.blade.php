...
@section('winner_css')
<link href="{{ asset('/css/Frederick_Soddy.css') }}" rel="stylesheet">
@endsection
...
{{-- Relationship --}}
    ...
    <img src="{{ asset('/icon/Frederick-Soddy2.jpg') }}" alt="">
    @endsection
...
{{-- Book --}}
    {{-- Book1 --}}
        @section('book_img1')
        <img src="{{ asset('icon/Book/Frederick_Soddy/1.png') }}" alt="">
        @endsection
    ...
    {{-- Book2 --}}
        @section('book_img2')
        <img src="{{ asset('icon/Book/Frederick_Soddy/The interpretation of radium.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book3 --}}
        @section('book_img3')
        <img src="{{ asset('icon/Book/Frederick_Soddy/3.jpg') }}" alt="">
        @endsection
