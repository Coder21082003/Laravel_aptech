...
@section('winner_css')
<link href="{{ asset('/css/Pearl_Buck.css') }}" rel="stylesheet">
@endsection
...
{{-- Book --}}
    {{-- Book1 --}}
        @section('book_img1')
        <img src="{{ asset('icon/Book/Pearl_Buck/1.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book2 --}}
        @section('book_img2')
        <img src="{{ asset('icon/Book/Pearl_Buck/2.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book3 --}}
        @section('book_img3')
        <img src="{{ asset('icon/Book/Pearl_Buck/3.jpg') }}" alt="">
        @endsection
