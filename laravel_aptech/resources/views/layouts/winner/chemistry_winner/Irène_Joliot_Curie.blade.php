...
@section('winner_css')
<link href="{{ asset('/css/Irène_Joliot_Curie.css') }}" rel="stylesheet">
@endsection
...
{{-- Relationship --}}
    ...
    <img src="{{ asset('icon/Irène Joliot-Curie-Marriage.jpg') }}" alt="">
    @endsection
...
{{-- Book --}}
    {{-- Book1 --}}
        @section('book_img1')
        <img src="{{ asset('icon/Book/Irène_Joliot_Curie/She Live For Science.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book2 --}}
        @section('book_img2')
        <img src="{{ asset('icon/Book/Irène_Joliot_Curie/Irên Jiliot Curie.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book3 --}}
        @section('book_img3')
        <img src="{{ asset('icon/Book/Irène_Joliot_Curie/Radioactive!.jpg') }}" alt="">
        @endsection
