...
@section('winner_css')
<link href="{{ asset('/css/Hendrik_Lorentz.css') }}" rel="stylesheet">
@endsection
...
{{-- Relationship --}}
    ...
    <img src="{{ asset('/icon/lorentz-career.jpg') }}" alt="">
    @endsection
...
{{-- Book --}}
    {{-- Book1 --}}
        @section('book_img1')
        <img src="{{ asset('icon/Book/Hendrik_Lorentz/The Einstein Theory of Relativity.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book2 --}}
        @section('book_img2')
        <img src="{{ asset('icon/Book/Hendrik_Lorentz/A Living Work of Art.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book3 --}}
        @section('book_img3')
        <img src="{{ asset('icon/Book/Hendrik_Lorentz/Clerk MaxWells Electromagnetic.png') }}" alt="">
        @endsection
