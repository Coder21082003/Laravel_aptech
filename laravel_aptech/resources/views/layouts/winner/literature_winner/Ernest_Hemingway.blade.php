...
@section('winner_css')
<link href="{{ asset('/css/Ernest_Hemingway.css') }}" rel="stylesheet">
@endsection
...
{{-- Relationship --}}
    ...
    <img src="{{ asset('icon/ernest-hemingway.jpg') }}" alt="">
    @endsection
...
{{-- Book --}}
    {{-- Book1 --}}
        @section('book_img1')
        <img src="{{ asset('icon/Book/Ernest_Hemingway/1.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book2 --}}
        @section('book_img2')
        <img src="{{ asset('icon/Book/Ernest_Hemingway/2.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book3 --}}
        @section('book_img3')
        <img src="{{ asset('icon/Book/Ernest_Hemingway/3.jpg') }}" alt="">
        @endsection
