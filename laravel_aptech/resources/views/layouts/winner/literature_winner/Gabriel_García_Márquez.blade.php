...
@section('winner_css')
<link href="{{ asset('/css/Gabriel_García_Márquez.css') }}" rel="stylesheet">
@endsection
...
{{-- Relationship --}}
    ...
    <img src="{{ asset('icon/Gabriel_García_MárquezM.webp') }}" alt="">
    @endsection
...
{{-- Book --}}
    {{-- Book1 --}}
        @section('book_img1')
        <img src="{{ asset('icon/Book/Gabriel_García_Márquez/1.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book2 --}}
        @section('book_img2')
        <img src="{{ asset('icon/Book/Gabriel_García_Márquez/2.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book3 --}}
        @section('book_img3')
        <img src="{{ asset('icon/Book/Gabriel_García_Márquez/3.jpg') }}" alt="">
        @endsection
...
{{-- Other winner --}}
    ...
    {{--1--}}
        ...
        <img src="{{asset('icon/ernest-hemingway-potrait.jpg')}}">  
        @endsection
    ...
    {{--2--}}
        ...
        <img src="{{asset('icon/pablo-neruda-potrait.jpg')}}">  
        @endsection
        ...
        <a href="@php echo route('Pablo_Neruda') @endphp" class="click">Click here to find more</a>
        @endsection


    {{--3--}}
        @section('other_winner_img3')
        <img src="{{asset('icon/PearlBuck-potrait.jpg')}}">  
        @endsection
        ...
        <a href="@php echo route('Pearl_Buck') @endphp" class="click">Click here to find more</a>
        @endsection


    {{--4--}}
        @section('other_winner_img4')
        <img src="{{asset('icon/GeorgeBernardShaw-potrait.jpg')}}">  
        @endsection
        ...
        <a href="@php echo route('George_Bernard_Shaw') @endphp" class="click">Click here to find more</a>
        @endsection

    
    {{-- 5 --}}
        {{-- @section('other_winner_img3')
        <img src="{{asset('icon/GabrielGarcíaMárquez-potrait.jpg')}}">  
        @endsection
        ...
        @section('other_winner_link3')
        <a href="@php echo route('Gabriel_García_Márquez') @endphp" class="click">Click here to find more</a>
        @endsection --}}
