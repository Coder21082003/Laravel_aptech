...
@section('winner_css')
<link href="{{ asset('/css/Harold_Urey.css') }}" rel="stylesheet">
@endsection
...
{{-- Relationship --}}
    ...
    <img src="{{ asset('/icon/Harold-Urey2.jpg') }}" alt="">
    @endsection
...
{{-- Book --}}
    {{-- Book1 --}}
        @section('book_img1')
        <img src="{{ asset('icon/Book/Harold_Urey/The Life and Science.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book2 --}}
        @section('book_img2')
        <img src="{{ asset('icon/Book/Harold_Urey/O sistema Solar.jpg')}}" alt="">
        @endsection
    ...
    {{-- Book3 --}}
        @section('book_img3')
        <img src="{{ asset('icon/Book/Harold_Urey/The Planets Their Origin and Development.jpg') }}" alt="">
        @endsection
