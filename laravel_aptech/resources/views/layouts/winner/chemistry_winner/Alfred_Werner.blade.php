...
@section('winner_css')
<link href="{{ asset('/css/Alfred_Werner.css') }}" rel="stylesheet">
@endsection
...
{{-- Relationship --}}
    ...
    <img src="{{ asset('/icon/Alfred-Werner2.jpg') }}" alt="">
    @endsection
...
{{-- Book --}}
    {{-- Book1 --}}
        @section('book_img1')
        <img src="{{ asset('icon/Book/Alfred_Werner/Idea_Chemistry.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book2 --}}
        @section('book_img2')
        <img src="{{ asset('icon/Book/Alfred_Werner/Dufy.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book3 --}}
        @section('book_img3')
        <img src="{{ asset('icon/Book/Alfred_Werner/Neww Ideas On Inorganic Chemistry .jpg') }}" alt="">
        @endsection
