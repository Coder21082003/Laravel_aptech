...
@section('winner_css')
<link href="{{ asset('/css/Hermann_Staudinger.css') }}" rel="stylesheet">
@endsection
...
{{-- Relationship --}}
    ...
    <img src="{{ asset('icon/Hermann-Staudinger-Marriage.jpg') }}" alt="">
    @endsection
...
{{-- Book --}}
    {{-- Book1 --}}
        @section('book_img1')
        <img src="{{ asset('icon/Book/Hermann_Staudinger/60 Year.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book2 --}}
        @section('book_img2')
        <img src="{{ asset('icon/Book/Hermann_Staudinger/From Organic Chemistry to Macromolecules A Scientific Autobiography Based on My Original Papers.jpg') }}" alt="">
        @endsection
    ...
    {{-- Book3 --}}
        @section('book_img3')
        <img src="{{ asset('icon/Book/Hermann_Staudinger/Die Hochmolekularen Organischen Verbindungen.jpg') }}" alt="">
        @endsection
...
{{-- Other winner --}}
    ...
    {{--1--}}
        ...
        <img src="{{asset('icon/Harold-Urey.jpg')}}">  
        @endsection
        ...
        <a href="@php echo route('Harold_Urey') @endphp" class="click">Click here to find more</a>
        @endsection


    {{--2--}}
        @section('other_winner_img2')   
        <img src="{{asset('icon/Frederick-Soddy.jpg')}}">  
        @endsection
        ...
        <a href="@php echo route('Frederick_Soddy') @endphp" class="click">Click here to find more</a>
        @endsection


    {{--3--}}
        @section('other_winner_img3')
        <img src="{{asset('icon/Alfred-Werner.jpg')}}">  
        @endsection
        ...
        <a href="@php echo route('Alfred_Werner') @endphp" class="click">Click here to find more</a>
        @endsection


    {{--4--}}
        @section('other_winner_img4')
        <img src="{{asset('icon/Irène Joliot-Curie.jpg')}}">  
        @endsection
        ...
        <a href="@php echo route('Irène_Joliot_Curie') @endphp" class="click">Click here to find more</a>
        @endsection

    
    {{-- 5 --}}
        {{-- @section('other_winner_img3')
        <img src="{{asset('icon/Hermann-Staudinger.jpg')}}">  
        @endsection
        ...
        @section('other_winner_link3')
        <a href="@php echo route('Hermann_Staudinger') @endphp" class="click">Click here to find more</a>
        @endsection --}}
